...
const data = [
  ...
  {text: 'nothing...', me: 1},
  {
    text: "Wanna do something tonight? my girlfriend is working and I'm bored.",
    me: 1,
  },
...
const DemoSizeMattersChat = ({scale}) => {
...
export default withScaledSheetSwitch(DemoSizeMattersChat);
