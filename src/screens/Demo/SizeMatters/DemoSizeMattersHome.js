...
const DemoSizeMattersHome = ({navigation, scale}) => {
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity
        style={styles.button}
        onPress={() =>
          navigation.navigate(SCREEN_STACK_ROUTE_NAME.DemoSizeMattersFeed)
        }>
      ...
      <TouchableOpacity
        style={styles.button}
        onPress={() =>
          navigation.navigate(SCREEN_STACK_ROUTE_NAME.DemoSizeMattersChat)
        }>
...
export default withScaledSheetSwitch(DemoSizeMattersHome);
